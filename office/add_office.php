                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu ml-auto" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item active" href="../office/Add_office.php" class="nav-link">Add
                                    Office</a>
                            </li>
            ...
            <div class="row d-flex mb-5 contact-info">
                ...
                <div class="col-md-8 block-9 mb-md-5">
                    <form action="<?= URL . "handlers/office/store.php"; ?>" class="bg-light p-5 contact-form"
                        ...
                        <div class="form-group">
                            <input type="submit" value="Add Office" class="btn btn-primary py-3 px-5" name="submit">
                        </div>
                    </form>
                </div>
            </div>
