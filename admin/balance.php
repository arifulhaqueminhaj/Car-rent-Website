        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="../admin/admin.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Add Balance <i class="ion-ios-arrow-forward"></i></span></p>
                    <h1 class="mb-3 bread">Add Balance</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div style="width: 50%; height: 550px; float:left;">
                <div class="container" style="position:relative; left:180px; top:2px;">
                    ...
                    <form method="POST" action="<?= URL . "handlers/balance/credit_card.php"; ?>">
                        ...
                        <input class="btn btn-primary py-3 px-5" type="submit" name="submit" value="Confirm">
                    </form>
                </div>
            </div>
