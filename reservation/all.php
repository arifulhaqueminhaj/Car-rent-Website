        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu ml-auto" aria-labelledby="navbarDropdownMenuLink">
                        <li><a class="dropdown-item active" href="../reservation/all.php" class="nav-link">View
                                Reservations</a></li>
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="../admin/admin.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>View Reservations <i class="ion-ios-arrow-forward"></i></span></p>
                    <h1 class="mb-3 bread">View Reservations</h1>
                </div>
            </div>
        </div>
    </section>
