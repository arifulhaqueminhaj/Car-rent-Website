            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu ml-auto" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item active" href="<?= URL . "views/car/all_cars.php" ?> " class="nav-link">View cars</a></li>
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="../admin/admin.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>View Cars<i class="ion-ios-arrow-forward"></i></span></p>
                    <h1 class="mb-3 bread">View Cars</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="ftco-section contact-section">
        ...
        <div class="container">
            ...
            <table class=" table table-dark">
                <thead>
                    <tr>
                        <th scope="col" class="text-center">Plate ID</th>
                ...
                <tbody class="text-center">
                    ...
                    ?>
                        <tr>
                            <th><?= $car['plate_id'] ?></th>
                            <td width="300px"> <img style="  height: 30%;
  width: 30%;" src="<?= URL . "uploads/images/cars/" . $car['plate_id'] . ".jpg" ?>" alt="Car of The Image"></td>
                            <td><?= $car['brand'] ?></td>
                            <td><?= $car['body'] ?></td>
                            <td><?= $car['model'] ?></td>
                            <td><?= $car['color'] ?></td>
