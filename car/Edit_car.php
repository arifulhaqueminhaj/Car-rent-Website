            ...
            <div class="row d-flex mb-5 contact-info">
                ...
                <div class="col-md-8 block-9 mb-md-5">
                    ...
                    <form class="bg-light p-5 contact-form" method="POST" action="<?= URL . "handlers/car/update.php" ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <select name="status" id="status" value="<?= $car['status'] ?>" required>
                        ...
                        <div class="form-group">
                            <input type="number" step="0.01" name="price_per_day" id="price_per_day" class="form-control" placeholder="Price per day" value="<?= $car['price_per_day'] ?>" required>
                        </div>
                        <div class="form-group">
