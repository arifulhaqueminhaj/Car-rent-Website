            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu ml-auto" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item active" href="../reports/report3.php" class="nav-link">Report3</a>
                        </li>
            ...
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="../admin/admin.php">Home <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span>Report 3 <i
                                class="ion-ios-arrow-forward"></i></span></p>
                    <h1 class="mb-3 bread">Report 3</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div>
                <div class="services services-2 w-100 text-center">
                    ...
                    <div class="text w-100">
                        <h3 class="heading mb-2">Report 3</h3>
                        <p>
                            The status of all cars on a specific day
                        </p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row d-flex mb-5 contact-info">
                    ...
                    <div class="col-md-8 block-9 mb-md-5">
                        <form class="bg-light p-5 contact-form" action="<?= URL . "handlers/reports/r3.php"; ?>"
                            method="POST" enctype="multipart/form-data">

                            <div class="form-group">
                                <label for="html">Enter date of specific day:</label><br>
                                <input class="form-control" type="date" name="date" id="date" placeholder="yyyy-mm-dd"
                                    value='' required>
                            </div>
